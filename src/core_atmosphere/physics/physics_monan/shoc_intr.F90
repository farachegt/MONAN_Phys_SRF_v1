module shoc_intr
  ...
  ! TODO: Get equivalents imports in MONAN project
  ...
  ! TODO: Check this phys_control.F90 to assign values to eddy_scheme and deep_scheme
